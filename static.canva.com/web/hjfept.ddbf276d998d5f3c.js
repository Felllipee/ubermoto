...
${H(h)}`);
                    ...
                    Ve = function({
                        ...
                        a = new Te(b, p, h, n, c, g, (a === null || a === void 0 ? 0 : a.Yi) ? new Map : void 0);
                        p.X = a;
                        a.La(() => {
                    ...
                    async fetch(a, {
                        ...
                        return this.l.ob("fetch_from_network", b, async () => {
                            ...
                            if (a.request.mode === "navigate") {
                                ...
                                if (this.Ed != null) return c = await Hb(this.Ed, a.request), this.wc(c)
                            }
                            return this.wc(a.request, {
                                redirect: "follow"
                            })
                        })
                    }
                    ...
                    ua(a, b, c) {
                        try {
                            ...
                            const {
                                Nb: e,
                                Ob: f
                            } = Le(c), g = ha(this.U(b), "No instrumentation scope found for '{}' of parent '{}:{}'", a, b === null || b === void 0 ? void 0 : b.U, b === null || b === void 0 ? void 0 : b.context.spanId), h = (f === null || f === void 0 ? 0 : (d = f.performance) === null || d === void 0 ? 0 : d.bi) ? this.dc.frameRate() : void 0;
...
//# sourceMappingURL=sourcemaps/hjfept.ddbf276d998d5f3c.js.map