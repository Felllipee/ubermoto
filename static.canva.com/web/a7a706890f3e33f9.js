    ...
    [28646], {
        ...
        82986: function(_, __, __webpack_require__) {
            ...
            (function(__c) {
                ...
                var E = __c.E;
                var Fa = __c.Fa;
                var kJb, lJb, nJb, mJb, pJb, sJb, rJb, wJb, zJb, AJb, DJb, FJb, GJb, HJb, T6, U6, IJb, JJb, KJb, MJb, OJb, PJb, UJb, VJb, Y6, WJb, XJb, YJb, ZJb, $Jb, aKb;
                __c.N6 = function(a) {
                    return {
                        type: 1,
                        Component: a
                ...
                kJb = function({
                    ...
                    var b = jJb.get(a.a6);
                    if (!b) throw Error(`Blueprint ${a.a6} not found`);
                    b = b.$bb.find(c => c.Gha === a.Gha);
                    if (!b) throw Error(`Variant ${a.Gha} not found for blueprint ${a.a6}`);
                    return {
                        $a: b.$a
                    }
                };
                ...
                nJb = async function(a, b) {
                    ...
                    if (e) {
                        ...
                        var f = setInterval(() => a.cR.AN.send({
                            type: "ack",
                            requestId: c
                        }), 9E3);
                        try {
                            ...
                            if (k instanceof R6) {
                                var h = k;
                                k.code === "internal_error" ? a.M.wb(k, {
                    ...
                    } else h = mJb(a.cR, c, "internal_error", `No request handler configured for path: "${d}".`),
                        h.ok || a.M.eO(h.error, {
                            re: "unable to send error response",
                            tags: new Map([
                                ["type", "request"],
                ...
                pJb = function({
                    ...
                    if (b.length !== 0 || !c.contains("allow-same-origin")) return oJb;
                    a = (new URL(a)).origin;
                    return a === "null" ? oJb : {
                        Cha: a,
                        Uya: a
                ...
                sJb = async function(a, b, c, {
                    ...
                    c = ({
                        ...
                        var n;
                        (k === null || k === void 0 ? 0 : (n = k.source) === null || n === void 0 ? 0 : n.startsWith("react-")) || (m !== g.Cha ? rJb(m) || b.info("received message event from an unexpected origin", {
                            extra: new Map([
                                ["expected", g.Cha],
                                ["actual", m]
                            ])
                            ...
                            source: "parent"
                        }, g.Uya, [a]), f.resolve(void 0)) : b.w3(l.error, {
                            extra: new Map([
                                ["data.source", k === null || k === void 0 ? void 0 : k.source]
                            ])
                        })))
                ...
                rJb = function(a) {
                    return tJb.some(b => a.endsWith(b))
                };
                wJb = function(a, b) {
                    var c = uJb,
                        d = vJb;
                    a.handle("SET_CONFIG", async e => {
                        if (e === void 0) throw new R6({
                            code: "internal_error",
                ...
                zJb = async function(a, b) {
                    a = await a.Bma.request("RENDER_ELEMENT", xJb.serialize(b));
                    ...
                    return yJb.deserialize(a.value)
                };
                AJb = function(a) {
                    wJb(a.Bma, b => a.handler.CNa(b))
                };
                DJb = async function(a, b, c) {
                    const {
                        port1: d,
                        port2: e
                    } = new MessageChannel, f = new BJb(d, c);
                    await sJb(e, c, a, window);
                    return new CJb(f, b)
                };
                FJb = function({
                    M: a
                ...
                HJb = function(a) {
                    const b = a.color;
                    a = a.Ra;
                    return b ? b : a.ref ? a.ref.Qi[0].color : "#ffffff"
                };
                T6 = function(a, b) {
                ...
                U6 = function(a, b) {
                    return {
                        type: "text2",
                        text: eo.create(eo.Yb().attrs(b).Ib(a + "\n").build())
                    }
                };
                IJb = function(a, b) {
                    return {
                ...
                MJb = function(a) {
                    ...
                    return S6("div", {
                        className: "LMc7Uw",
                        children: a.options.map(d => S6(LJb, {
                            children: b(d)
                        }, c(d)))
                    })
                };
                OJb = function(a) {
                    ...
                    const e = b !== c,
                        f = NJb(() => {
                            var g = T6(c, V6),
                                h = e ? b : g;
                            g = __c.cL("#000000", c) >= 20 ? "#000000" : T6(c, V6);
                            h = __c.cL(h, c) >= 20 ? h : T6(c, V6);
                            return d && e ? h : g
                        }, [e, d, b, c]);
                    return S6("div", {
                        className: "WYWuyA",
                        style: {
                            "--bETJ2A": d ? __c.lE(__c.hE(__c.WD(f), e ? .5 : .08)) : __c.lE(__c.hE(__c.WD(f), .08)),
                            "--yYV0bA": __c.lE(__c.hE(__c.WD(f), .12)),
                            "--mxkqAA": __c.lE(__c.hE(__c.WD(f), .26))
                        },
                        children: a
                    })
                };
                ...
                UJb = function(a) {
                    ...
                    switch (b) {
                        case 0:
                            return W6(a.sZ(), c, d, T6(e, QJb), f);
                        case 1:
                            return W6(a.loading(), c, d, T6(e, RJb), f);
                        case 2:
                            return W6(a.Aea(), c, d, T6(e, RJb), f);
                        case 3:
                            return W6(a.mba(), c, d, T6(e, SJb), f);
                        case 4:
                            return W6(a.dea(), c, d, T6(e, TJb), f);
                        default:
                            throw new E(b);
                    }
                };
                ...
                __c.Ed.prototype.eO = __c.ca(3, function(a, b) {
                    this.console.error(...__c.id(this, "critical", a, b))
                });
                __c.Fd.prototype.eO = __c.ca(2, function(a, b) {
                    __c.Dd(this, "fatal", a, b)
                });
                __c.X6 = {};
                Y6 = __webpack_require__(519427);
                WJb = Y6.action;
                XJb = Y6.observable;
                YJb = Y6.ObservableMap;
                ZJb = Y6.reaction;
                $Jb = Y6.runInAction;
                aKb = Y6.untracked;
                var bKb = __webpack_require__(443763),
                    S6 = bKb.jsx,
                    Z6 = bKb.jsxs;
                var $6 = __webpack_require__(875604),
                    LJb = $6.Fragment,
                    cKb = $6.memo,
                    dKb = $6.useEffect,
                    NJb = $6.useMemo,
                    a7 = $6.useState;
                var eKb = __webpack_require__(635872).Om;
                var fKb = __webpack_require__(446474).Pi;
                var iJb = Object.freeze({
                ...
                var jJb = new YJb,
                    gKb = __c.Q6({
                        element: {
                            a6: __c.P6("blueprintId", 0),
                            Gha: __c.P6("variantId", 0)
                        }
                    });
                var hKb = {
                    DA: __c.O6()(() => ({
                    ...
                    constructor(a, b, c) {
                        ...
                        this.JSa = ({
                            ...
                            if (d) try {
                                ...
                                this.M.wb(e)
                            } else this.M.error(new R6({
                                code: "internal_error",
                                message: "missing data in 'MessageEvent'"
                            }))
                        };
                        this.port.onmessage = this.JSa;
                        this.port.onmessageerror = this.KSa
                    }
                };
                var kKb = class extends Error {
                        constructor() {
                        ...
                        const c = this.Awa,
                            ...
                            f = async function() {
                                ...
                                try {
                                    ...
                                    return g instanceof kKb ? Fa(new R6({
                                        code: "internal_error",
                ...
                var mKb = class {
                    handle(a, b) {
                        if (this.requestHandler.has(a)) throw new R6({
                            code: "internal_error",
                            ...
                            a = new nKb(c => {
                                switch (c.type) {
                                    ...
                                    case "response":
                                        ...
                                        break;
                                    case "request":
                                        nJb(this.requestHandler, c);
                                        break;
                                    default:
                                        throw new E(c);
                                }
                            }, a, b.el("bus"));
                            this.client = new lKb(a.bz, b.el("client"));
                            this.requestHandler = new mKb(a, b.el("requestHandler"))
                        }
                    },
                    nKb = class {
                        constructor(a, b, c) {
                            this.oY = a;
                            this.bz = (d, e, f) => this.AN.send({
                                type: "request",
                                requestId: d,
                                path: e,
                                payload: f
                ...
                var tJb = "canva-dev.com canva-dev.cn canva-staging.com canva-staging.cn canva.com canva.cn canva-apps.com canva-apps.cn canva-apps-dev.com canva-apps-dev.cn canva-apps-staging.com canva-apps-staging.cn".split(" ");
                var xJb = L(() => ({
                    config: __c.Z(1)
                }));
                var oKb = L(() => ({
                ...
                var EJb = class {
                    async xv(a, b) {
                        const c = await DJb(a, {
                                CNa: e => {
                                    $Jb(() => b.config = e.config);
                                    return new vJb
                                }
                            }, this.M),
                            d = ZJb(() => b.config, async e => {
                                const f = await zJb(c, {
                                    config: e
                                });
                                f.config && f.config !== e && $Jb(() => b.config = f.config)
                            }, {
                                fireImmediately: !0
                            });
                        this.ps.set(a, d)
                    ...
                    FK(a) {
                        var b;
                        (b = this.ps.get(a)) === null || b === void 0 || b();
                        this.ps.delete(a)
                    }
                    constructor(a) {
                        this.M = a;
                ...
                var V6 = ["#000000", "#ffffff"],
                    sKb = eKb((a, b) => {
                        const c = eo.create(eo.ka(a));
                        aKb(() => {
                            c.hh({
                                direction: GJb(b)
                            })
                ...
                (a => ({
                    type: "select",
                    id: jd(),
                    label: U6(O("RHbyaA"), IJb("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily)),
                    options: [O("ubIbsA"), O("Ic3T0Q"), O("gWITaA"), O("VqqAfQ")].map(b => ({
                        id: jd(),
                        label: U6(b, JJb("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily))
                    })),
                    P: 8,
                    l7: [],
                    qsa: "c",
                ...
                __c.VI.create({ ...__c.BQ,
                    weight: 0,
                    color: "#000000"
                });
                __c.yQ.create({ ...__c.AQ,
                    color: "#05805f"
                });
                __c.yQ.create({ ...__c.AQ,
                    color: "#05805f"
                ...
                var tKb, uKb = jd(),
                    ...
                    wKb = [(a => {
                        ...
                        return {
                            type: "select",
                            id: jd(),
                            label: U6(O("4JB6gw"), IJb("#0079a9", a === null || a === void 0 ? void 0 : a.fontFamily)),
                            options: b.map(c => ({
                                id: c.id,
                                label: U6(c.label, JJb("#0079a9", a === null || a === void 0 ? void 0 : a.fontFamily))
                            })),
                            P: 8,
                            l7: b.filter(c => c.mQ).map(c => c.id),
                            qsa: "c",
                            ...a
                        }
                    })({
                ...
                tKb = {
                    ...
                    header: {},
                    yY: !1,
                    border: __c.VI.create({ ...__c.BQ,
                        weight: 0,
                        color: "#000000"
                    }),
                    P: 16,
                    Hp: __c.yQ.create({ ...__c.AQ,
                        color: "#0079a9"
                    }),
                    Np: __c.yQ.create({ ...__c.AQ,
                        color: "#0079a9"
                    }),
                    Aj: __c.Dh.ac["font-family"],
                    direction: "l",
                    ...(void 0)
                };
                var yKb = __c.Q6({
                ...
                var zKb = {
                    ...
                    AKb = class {
                        ...
                        mg(a) {
                            var b;
                            return (((b = this.hw) === null || b === void 0 ? void 0 : b.get(this.document.language || "en")) || [])[zKb[a]]
                        }
                        dea() {
                            return this.mg("somethingWentWrong") || O("Z3F9sQ")
                        }
                        sZ() {
                            return this.mg("live") || O("2LB66w")
                        }
                        $ma() {
                            return this.mg("correctLabel") || O("uXYgEw")
                        }
                        jra() {
                        ...
                        dya() {
                            return this.mg("responseSaved") || O("JWFDXg")
                        }
                        Wua(a) {
                            const b = this.mg("numVotes");
                            return b ? __c.Lb(b, [a], this.document.language) : __c.Db("WZ3eIA", [a])
                        }
                        eya(a) {
                            const b = this.mg("resultsPercentage");
                            return b ? __c.Lb(b, [a], this.document.language) : __c.Db("a8YHbA", [a])
                        }
                        mba() {
                            return this.mg("offline") || O("H7ta1A")
                        }
                        loading() {
                            return this.mg("loading") || O("/0w0UQ")
                        }
                        Aea() {
                            return this.mg("submitting") || O("+ecJQQ")
                        }
                        ria() {
                            return this.mg("yourNameWontBeShared") || O("lC0Mpw")
                        }
                        qia() {
                ...
                __c.kBa = {
                    UOa: function(a) {
                        ...
                        const c = a.dia,
                            d = a.bU;
                        return {
                            H1a: b("w:wnJF5T87v", hKb),
                            $2a: a.sKa ? Promise.all([__webpack_require__.me(697956).then(() => __c.EKb), __webpack_require__.me(411625).then(() => __c.FKb), __webpack_require__.me(305660).then(() => __c.GKb), __webpack_require__.me(696820).then(() => __c.HKb)]).then(([e, f, g, h]) => ({
                                W2a: b("w:cm9wgGptP", e),
                                X2a: b("w:yLMS4dWnl", f),
                                Y2a: b("w:2flp30CGQ", g),
                                Z2a: b("w:1Nv6K6Dtv", h)
                            ...
                            form: b("w:6JG6DxspF", DKb),
                            obb: a.mKa ? __webpack_require__.me(852979).then(() => __c.IKb).then(e => b("w:2pbXJMtm1", e)) : void 0
                        }
                    }
                };
...
//# sourceMappingURL=sourcemaps/a7a706890f3e33f9.js.map