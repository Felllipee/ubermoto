    ...
    [28646], {
        ...
        82986: function(_, __, __webpack_require__) {
            ...
            (function(__c) {
                ...
                var E = __c.E;
                var Fa = __c.Fa;
                var lJb, mJb, oJb, nJb, qJb, tJb, sJb, xJb, AJb, BJb, EJb, GJb, HJb, IJb, S6, T6, JJb, KJb, LJb, NJb, PJb, QJb, VJb, WJb, X6, XJb, YJb, ZJb, $Jb, aKb, bKb;
                __c.M6 = function(a) {
                    return {
                        type: 1,
                        Component: a
                ...
                lJb = function({
                    ...
                    var b = kJb.get(a.Z5);
                    if (!b) throw Error(`Blueprint ${a.Z5} not found`);
                    b = b.fcb.find(c => c.Gha === a.Gha);
                    if (!b) throw Error(`Variant ${a.Gha} not found for blueprint ${a.Z5}`);
                    return {
                        $a: b.$a
                    }
                };
                ...
                oJb = async function(a, b) {
                    ...
                    } else h = nJb(a.cR, c, "internal_error", `No request handler configured for path: "${d}".`),
                        h.ok || a.M.eO(h.error, {
                            re: "unable to send error response",
                            tags: new Map([
                                ["type", "request"],
                ...
                qJb = function({
                    ...
                    if (b.length !== 0 || !c.contains("allow-same-origin")) return pJb;
                    a = (new URL(a)).origin;
                    return a === "null" ? pJb : {
                        Cha: a,
                        Wya: a
                ...
                tJb = async function(a, b, c, {
                    ...
                    c = ({
                        ...
                        var n;
                        (k === null || k === void 0 ? 0 : (n = k.source) === null || n === void 0 ? 0 : n.startsWith("react-")) || (m !== g.Cha ? sJb(m) || b.info("received message event from an unexpected origin", {
                            extra: new Map([
                                ["expected", g.Cha],
                                ["actual", m]
                            ])
                            ...
                            source: "parent"
                        }, g.Wya, [a]), f.resolve(void 0)) : b.w3(l.error, {
                            extra: new Map([
                                ["data.source", k === null || k === void 0 ? void 0 : k.source]
                            ])
                        })))
                ...
                sJb = function(a) {
                    return uJb.some(b => a.endsWith(b))
                };
                xJb = function(a, b) {
                    var c = vJb,
                        d = wJb;
                    a.handle("SET_CONFIG", async e => {
                        if (e === void 0) throw new Q6({
                            code: "internal_error",
                ...
                AJb = async function(a, b) {
                    a = await a.Cma.request("RENDER_ELEMENT", yJb.serialize(b));
                    ...
                    return zJb.deserialize(a.value)
                };
                BJb = function(a) {
                    xJb(a.Cma, b => a.handler.ENa(b))
                };
                EJb = async function(a, b, c) {
                    const {
                        port1: d,
                        port2: e
                    } = new MessageChannel, f = new CJb(d, c);
                    await tJb(e, c, a, window);
                    return new DJb(f, b)
                };
                GJb = function({
                    M: a
                ...
                NJb = function(a) {
                    ...
                    return R6("div", {
                        className: "LMc7Uw",
                        children: a.options.map(d => R6(MJb, {
                            children: b(d)
                        }, c(d)))
                    })
                };
                PJb = function(a) {
                    ...
                    const e = b !== c,
                        f = OJb(() => {
                            var g = S6(c, U6),
                                h = e ? b : g;
                            g = __c.bL("#000000", c) >= 20 ? "#000000" : S6(c, U6);
                            h = __c.bL(h, c) >= 20 ? h : S6(c, U6);
                            return d && e ? h : g
                        }, [e, d, b, c]);
                    return R6("div", {
                        className: "WYWuyA",
                ...
                VJb = function(a) {
                    ...
                    switch (b) {
                        case 0:
                            return V6(a.sZ(), c, d, S6(e, RJb), f);
                        case 1:
                            return V6(a.loading(), c, d, S6(e, SJb), f);
                        case 2:
                            return V6(a.Aea(), c, d, S6(e, SJb), f);
                        case 3:
                            return V6(a.mba(), c, d, S6(e, TJb), f);
                        case 4:
                            return V6(a.dea(), c, d, S6(e, UJb), f);
                        default:
                            throw new E(b);
                    }
                };
                ...
                __c.W6 = {};
                X6 = __webpack_require__(519427);
                XJb = X6.action;
                YJb = X6.observable;
                ZJb = X6.ObservableMap;
                $Jb = X6.reaction;
                aKb = X6.runInAction;
                bKb = X6.untracked;
                var cKb = __webpack_require__(443763),
                    R6 = cKb.jsx,
                    Y6 = cKb.jsxs;
                var Z6 = __webpack_require__(875604),
                    MJb = Z6.Fragment,
                    dKb = Z6.memo,
                    eKb = Z6.useEffect,
                    OJb = Z6.useMemo,
                    $6 = Z6.useState;
                var fKb = __webpack_require__(635872).Om;
                var gKb = __webpack_require__(446474).Pi;
                var jJb = Object.freeze({
                ...
                var kJb = new ZJb,
                    hKb = __c.P6({
                        element: {
                            Z5: __c.O6("blueprintId", 0),
                            Gha: __c.O6("variantId", 0)
                        }
                    });
                var iKb = {
                    EA: __c.N6()(() => ({
                        ...
                        const c = this.Cwa,
                            ...
                            f = async function() {
                                ...
                                try {
                                    ...
                                    return g instanceof lKb ? Fa(new Q6({
                                        code: "internal_error",
                ...
                var nKb = class {
                    handle(a, b) {
                        if (this.requestHandler.has(a)) throw new Q6({
                            code: "internal_error",
                            ...
                            a = new oKb(c => {
                                switch (c.type) {
                                    ...
                                    case "response":
                                        ...
                                        break;
                                    case "request":
                                        oJb(this.requestHandler, c);
                                        break;
                                    default:
                                        throw new E(c);
                                }
                            }, a, b.fl("bus"));
                            this.client = new mKb(a.cz, b.fl("client"));
                            this.requestHandler = new nKb(a, b.fl("requestHandler"))
                        }
                    },
                    oKb = class {
                        constructor(a, b, c) {
                            this.oY = a;
                            this.cz = (d, e, f) => this.AN.send({
                                type: "request",
                                requestId: d,
                                path: e,
                                payload: f
                ...
                var uJb = "canva-dev.com canva-dev.cn canva-staging.com canva-staging.cn canva.com canva.cn canva-apps.com canva-apps.cn canva-apps-dev.com canva-apps-dev.cn canva-apps-staging.com canva-apps-staging.cn".split(" ");
                var yJb = L(() => ({
                    config: __c.Z(1)
                }));
                var pKb = L(() => ({
                ...
                var FJb = class {
                    async xv(a, b) {
                        const c = await EJb(a, {
                                ENa: e => {
                                    aKb(() => b.config = e.config);
                                    return new wJb
                                }
                            }, this.M),
                            d = $Jb(() => b.config, async e => {
                                const f = await AJb(c, {
                                    config: e
                                });
                                f.config && f.config !== e && aKb(() => b.config = f.config)
                            }, {
                                fireImmediately: !0
                            });
                        this.ps.set(a, d)
                ...
                (a => ({
                    type: "select",
                    id: jd(),
                    label: T6(O("RHbyaA"), JJb("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily)),
                    options: [O("ubIbsA"), O("Ic3T0Q"), O("gWITaA"), O("VqqAfQ")].map(b => ({
                        id: jd(),
                        label: T6(b, KJb("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily))
                    })),
                    P: 8,
                    k7: [],
                    rsa: "c",
                ...
                __c.UI.create({ ...__c.AQ,
                    weight: 0,
                    color: "#000000"
                });
                __c.xQ.create({ ...__c.zQ,
                    color: "#05805f"
                });
                __c.xQ.create({ ...__c.zQ,
                    color: "#05805f"
                ...
                var uKb, vKb = jd(),
                    ...
                    xKb = [(a => {
                        ...
                        return {
                            type: "select",
                            id: jd(),
                            label: T6(O("4JB6gw"), JJb("#0079a9", a === null || a === void 0 ? void 0 : a.fontFamily)),
                            options: b.map(c => ({
                                id: c.id,
                                label: T6(c.label, KJb("#0079a9", a === null || a === void 0 ? void 0 : a.fontFamily))
                            })),
                            P: 8,
                            k7: b.filter(c => c.mQ).map(c => c.id),
                            rsa: "c",
                            ...a
                        }
                    })({
                ...
                uKb = {
                    ...
                    header: {},
                    yY: !1,
                    border: __c.UI.create({ ...__c.AQ,
                        weight: 0,
                        color: "#000000"
                    }),
                    P: 16,
                    Hp: __c.xQ.create({ ...__c.zQ,
                        color: "#0079a9"
                    }),
                    Np: __c.xQ.create({ ...__c.zQ,
                        color: "#0079a9"
                    }),
                ...
                var AKb = {
                    ...
                    BKb = class {
                        ...
                        mg(a) {
                            var b;
                            return (((b = this.hw) === null || b === void 0 ? void 0 : b.get(this.document.language || "en")) || [])[AKb[a]]
                        }
                        dea() {
                ...
                __c.lBa = {
                    WOa: function(a) {
                        ...
                        const c = a.dia,
                            d = a.bU;
                        return {
                            O1a: b("w:wnJF5T87v", iKb),
                            g3a: a.uKa ? Promise.all([__webpack_require__.me(697956).then(() => __c.FKb), __webpack_require__.me(411625).then(() => __c.GKb), __webpack_require__.me(305660).then(() => __c.HKb), __webpack_require__.me(696820).then(() => __c.IKb)]).then(([e, f, g, h]) => ({
                                c3a: b("w:cm9wgGptP", e),
                                d3a: b("w:yLMS4dWnl", f),
                                e3a: b("w:2flp30CGQ", g),
                                f3a: b("w:1Nv6K6Dtv", h)
                            ...
                            form: b("w:6JG6DxspF", EKb),
                            ubb: a.oKa ? __webpack_require__.me(852979).then(() => __c.JKb).then(e => b("w:2pbXJMtm1", e)) : void 0
                        }
                    }
                };
...
//# sourceMappingURL=sourcemaps/cdc45295495b3d3b.js.map