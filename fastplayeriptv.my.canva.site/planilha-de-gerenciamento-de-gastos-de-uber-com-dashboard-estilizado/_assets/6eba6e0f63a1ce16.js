    ...
    [60060], {
        ...
        82986: function(_, __, __webpack_require__) {
            ...
            (function(__c) {
                ...
                var E = __c.E;
                var Ha = __c.Ha;
                var u6b, v6b, x6b, w6b, z6b, C6b, B6b, G6b, J6b, K6b, N6b, P6b, Q6b, R6b, P5, Q5, S6b, T6b, U6b, W6b, Y6b, Z6b, d7b, e7b, U5, f7b, g7b, h7b, i7b, j7b, k7b;
                __c.J5 = function(a) {
                    return {
                        type: 1,
                        Component: a
                ...
                u6b = function({
                    ...
                    var b = t6b.get(a.jma);
                    if (!b) throw Error(`Blueprint ${a.jma} not found`);
                    b = b.variants.find(c => c.dQ === a.dQ);
                    if (!b) throw Error(`Variant ${a.dQ} not found for blueprint ${a.jma}`);
                    return {
                        Oa: b.Oa
                    }
                };
                ...
                x6b = async function(a, b) {
                    ...
                    } else h = w6b(a.H2, c, "internal_error", `No request handler configured for path: "${d}".`),
                        h.ok || a.H.VL(h.error, {
                            re: "unable to send error response",
                            tags: new Map([
                                ["type", "request"],
                ...
                z6b = function({
                    ...
                    if (b.length !== 0 || !c.contains("allow-same-origin")) return y6b;
                    a = (new URL(a)).origin;
                    return a === "null" ? y6b : {
                        cDa: a,
                        zYa: a
                ...
                C6b = async function(a, b, c, {
                    ...
                    c = ({
                        ...
                        var n;
                        (k === null || k === void 0 ? 0 : (n = k.source) === null || n === void 0 ? 0 : n.startsWith("react-")) || (m !== g.cDa ? B6b(m) || b.info("received message event from an unexpected origin", {
                            extra: new Map([
                                ["expected", g.cDa],
                                ["actual", m]
                            ])
                            ...
                            source: "parent"
                        }, g.zYa, [a]), f.resolve(void 0)) : b.NK(l.error, {
                            extra: new Map([
                                ["data.source", k === null || k === void 0 ? void 0 : k.source]
                            ])
                        })))
                ...
                B6b = function(a) {
                    return D6b.some(b => a.endsWith(b))
                };
                G6b = function(a, b) {
                    var c = E6b,
                        d = F6b;
                    a.handle("SET_CONFIG", async e => {
                        if (e === void 0) throw new N5({
                            code: "internal_error",
                ...
                J6b = async function(a, b) {
                    a = await a.TIa.request("RENDER_ELEMENT", H6b.dc(b));
                    ...
                    return I6b.Lb(a.value)
                };
                K6b = function(a) {
                    G6b(a.TIa, b => a.handler.pgb(b))
                };
                N6b = async function(a, b, c) {
                    const {
                        port1: d,
                        port2: e
                    } = new MessageChannel, f = new L6b(d, c);
                    await C6b(e, c, a, window);
                    return new M6b(f, b)
                };
                P6b = function({
                    H: a
                ...
                W6b = function(a) {
                    ...
                    return O5("div", {
                        className: "LMc7Uw",
                        children: a.options.map(d => O5(V6b, {
                            children: b(d)
                        }, c(d)))
                    })
                };
                Y6b = function(a) {
                    ...
                    const e = b !== c,
                        f = X6b(() => {
                            var g = P5(c, R5),
                                h = e ? b : g;
                            g = __c.ct("#000000", c) >= 20 ? "#000000" : P5(c, R5);
                            h = __c.ct(h, c) >= 20 ? h : P5(c, R5);
                            return d && e ? h : g
                        }, [e, d, b, c]);
                    return O5("div", {
                        className: "WYWuyA",
                        style: {
                            "--bETJ2A": d ? __c.Ss(__c.Ms(__c.Ns(f), e ? .5 : .08)) : __c.Ss(__c.Ms(__c.Ns(f), .08)),
                            "--yYV0bA": __c.Ss(__c.Ms(__c.Ns(f), .12)),
                            "--mxkqAA": __c.Ss(__c.Ms(__c.Ns(f), .26))
                        },
                        children: a
                    })
                };
                ...
                d7b = function(a) {
                    ...
                    switch (b) {
                        case 0:
                            return S5(a.Xca(), c, d, P5(e, $6b), f);
                        case 1:
                            return S5(a.loading(), c, d, P5(e, a7b), f);
                        case 2:
                            return S5(a.Lza(), c, d, P5(e, a7b), f);
                        case 3:
                            return S5(a.offline(), c, d, P5(e, b7b), f);
                        case 4:
                            return S5(a.gza(), c, d, P5(e, c7b), f);
                        default:
                            throw new E(b);
                    }
                };
                ...
                __c.sd.prototype.VL = __c.fa(3, function(a, b) {
                    this.console.error(...__c.rd(this, "critical", a, b))
                });
                __c.QL.prototype.VL = __c.fa(2, function(a, b) {
                    this.kt.VL(a, b);
                    __c.OL(this, a, "critical", b)
                });
                __c.T5 = {};
                U5 = __webpack_require__(519427);
                f7b = U5.action;
                g7b = U5.observable;
                h7b = U5.ObservableMap;
                i7b = U5.reaction;
                j7b = U5.runInAction;
                k7b = U5.untracked;
                var l7b = __webpack_require__(443763),
                    O5 = l7b.jsx,
                    V5 = l7b.jsxs;
                var W5 = __webpack_require__(875604),
                    ...
                    X6b = W5.useMemo,
                    X5 = W5.useState;
                var o7b = __webpack_require__(635872).Om;
                var p7b = __webpack_require__(446474).Pi;
                var s6b = Object.freeze({
                ...
                var t6b = new h7b,
                    q7b = __c.M5({
                        element: {
                            jma: __c.L5("blueprintId", 0),
                            dQ: __c.L5("variantId", 0)
                        }
                    });
                var r7b = {
                    oH: __c.K5()(() => ({
                ...
                var N5 = class extends Error {
                    constructor(a) {
                        ...
                        this.Zpb = a.message;
                        Object.setPrototypeOf(this, N5.prototype)
                    }
                };
                var t7b = class {
                    constructor(a, b, c) {
                        ...
                        this.onMessage = ({
                            ...
                            if (d) try {
                                ...
                                this.H.Eb(e)
                            } else this.H.error(new N5({
                                code: "internal_error",
                                message: "missing data in 'MessageEvent'"
                            }))
                        };
                        this.port.onmessage = this.onMessage;
                        this.port.onmessageerror = this.wnb
                    }
                };
                var u7b = class extends Error {
                        constructor() {
                        ...
                        const c = this.EVa,
                            ...
                            f = async function() {
                                ...
                                try {
                                    ...
                                    return g instanceof u7b ? Ha(new N5({
                                        code: "internal_error",
                ...
                var w7b = class {
                    handle(a, b) {
                        if (this.requestHandler.has(a)) throw new N5({
                            code: "internal_error",
                            ...
                            a = new x7b(c => {
                                switch (c.type) {
                                    ...
                                    case "response":
                                        ...
                                        break;
                                    case "request":
                                        x6b(this.requestHandler, c);
                                        break;
                                    default:
                                        throw new E(c);
                                }
                            }, a, b.tg("bus"));
                            this.client = new v7b(a.gz, b.tg("client"));
                            this.requestHandler = new w7b(a, b.tg("requestHandler"))
                        }
                    },
                    x7b = class {
                        constructor(a, b, c) {
                            this.kba = a;
                            this.gz = (d, e, f) => this.BY.send({
                                type: "request",
                                requestId: d,
                                path: e,
                                payload: f
                ...
                var D6b = "canva-dev.com canva-dev.cn canva-staging.com canva-staging.cn canva.com canva.cn canva-apps.com canva-apps.cn canva-apps-dev.com canva-apps-dev.cn canva-apps-staging.com canva-apps-staging.cn".split(" ");
                var H6b = L(() => ({
                    config: __c.Y(1)
                }));
                var y7b = L(() => ({
                ...
                var O6b = class {
                    async FB(a, b) {
                        const c = await N6b(a, {
                                pgb: e => {
                                    j7b(() => b.config = e.config);
                                    return new F6b
                                }
                            }, this.H),
                            d = i7b(() => b.config, async e => {
                                const f = await J6b(c, {
                                    config: e
                                });
                                f.config && f.config !== e && j7b(() => b.config = f.config)
                            }, {
                                fireImmediately: !0
                            });
                        this.jh.set(a, d)
                ...
                (a => ({
                    type: "select",
                    id: Kr(),
                    label: Q5(O("RHbyaA"), S6b("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily)),
                    options: [O("ubIbsA"), O("Ic3T0Q"), O("gWITaA"), O("VqqAfQ")].map(b => ({
                        id: Kr(),
                        label: Q5(b, T6b("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily))
                    })),
                    X: 8,
                    Ona: [],
                    fQa: "c",
                ...
                __c.QD.create({ ...__c.IQ,
                    weight: 0,
                    color: "#000000"
                });
                __c.OO.create({ ...__c.mv,
                    color: "#05805f"
                });
                __c.OO.create({ ...__c.mv,
                    color: "#05805f"
                ...
                var D7b, E7b = Kr(),
                    ...
                    G7b = [(a => {
                        ...
                        return {
                            type: "select",
                            id: Kr(),
                            label: Q5(O("4JB6gw"), S6b("#0079a9", a === null || a === void 0 ? void 0 : a.fontFamily)),
                            options: b.map(c => ({
                                id: c.id,
                                label: Q5(c.label, T6b("#0079a9", a === null || a === void 0 ? void 0 : a.fontFamily))
                            })),
                            X: 8,
                            Ona: b.filter(c => c.v1).map(c => c.id),
                            fQa: "c",
                            ...a
                        }
                    })({
                ...
                D7b = {
                    ...
                    header: {},
                    G0: !1,
                    border: __c.QD.create({ ...__c.IQ,
                        weight: 0,
                        color: "#000000"
                    }),
                    X: 16,
                    qu: __c.OO.create({ ...__c.mv,
                        color: "#0079a9"
                    }),
                    yu: __c.OO.create({ ...__c.mv,
                        color: "#0079a9"
                    }),
                ...
                var J7b = {
                    ...
                    K7b = class {
                        ...
                        ei(a) {
                            var b;
                            return (((b = this.xC) === null || b === void 0 ? void 0 : b.get(this.document.language || "en")) || [])[J7b[a]]
                        }
                        gza() {
                ...
                __c.KRa = {
                    Phb: function(a) {
                        ...
                        const c = a.IDa,
                            d = a.W6;
                        return {
                            IAb: b("w:wnJF5T87v", r7b),
                            wCb: a.jcb ? Promise.all([__webpack_require__.me(697956).then(() => __c.O7b), __webpack_require__.me(411625).then(() => __c.P7b), __webpack_require__.me(305660).then(() => __c.Q7b), __webpack_require__.me(696820).then(() => __c.R7b)]).then(([e, f, g, h]) => ({
                                sCb: b("w:cm9wgGptP", e),
                                tCb: b("w:yLMS4dWnl", f),
                                uCb: b("w:2flp30CGQ", g),
                                vCb: b("w:1Nv6K6Dtv", h)
                            ...
                            form: b("w:6JG6DxspF", N7b),
                            FOb: a.ecb ? __webpack_require__.me(852979).then(() => __c.S7b).then(e => b("w:2pbXJMtm1", e)) : void 0
                        }
                    }
                };
...
//# sourceMappingURL=sourcemaps/6eba6e0f63a1ce16.js.map