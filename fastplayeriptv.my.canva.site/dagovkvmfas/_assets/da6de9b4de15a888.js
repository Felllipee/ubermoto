        ...
        605338: function(_, __, __webpack_require__) {
            ...
            (function(__c) {
                ...
                var a1b = function(a) {
                    ...
                    X3 = function(a, b) {
                        a = a.L0a.get(b);
                        if (a == null) throw new b1b("ref does not exists");
                        return a
                    },
                    $3 = function(a) {
                        const b = (c, d) => {
                            if (c == null && a != null) return a;
                            if ((c === null || c === void 0 ? void 0 : c.type) !== "string") throw d === "toWidgetData" ? new Y3("string", c) : new Z3("string", c);
                            return c.value
                        };
                        return {
                            Ik: c => ({
                    ...
                    b4 = function(a, b) {
                        if (a.length === 0) throw new a4("At least one value must be provided for literal types.");
                        const c = new Set(a),
                            d = (e, f) => {
                                if (e == null) return b;
                                if ((e === null || e === void 0 ? void 0 : e.type) !== "string" || !c.has(e.value)) throw f === "toWidgetData" ? new Y3("literal", e) : new Z3("literal", e);
                                return e.value
                            };
                        return {
                            Ik: e => ({
                    ...
                    c4 = function(a) {
                        const b = (c,
                            ...
                            if ((c === null || c === void 0 ? void 0 : c.type) !== "double" || !Number.isFinite(c.value)) throw d === "toWidgetData" ? new Y3("double", c) : new Z3("double", c);
                            return c.value
                        };
                        return {
                            Ik: c => {
                                if (!Number.isFinite(c)) throw new c1b(c);
                                return {
                                    type: "double",
                                    value: c
                                }
                    ...
                    e4 = function(a) {
                        ...
                        for (const d of Object.keys(a)) {
                            const [e] = a[d];
                            if (b.has(e)) throw new a4(`Duplicate serialized keys "${e}" found in record schema.`);
                            b.add(e)
                        }
                        const c = (d, e) => {
                            if ((e === null || e === void 0 ? void 0 : e.type) !== "dict") throw new Y3("record", e);
                            const f = {};
                        ...
                        return {
                            ...
                            Ds: d => {
                                if ((d === null || d === void 0 ? void 0 : d.type) !== "dict") throw new Z3("record", d);
                                const e = {};
                                for (const f of Object.keys(a)) {
                    ...
                    g1b = function(a) {
                        const b = () => a.Kj.vz.get(a.Pe.uz) || i4;
                        return {
                            oT: function() {
                                return a.Kj.Hj ? 3 : a.Kj.zhb ===
                            ...
                            yfb: function(c, d) {
                                ...
                                if (!c) return 0;
                                var f;
                                d = (f = c.fJ.get(d)) !== null && f !== void 0 ? f : 0;
                    ...
                    k1b = function(a, b, c, d, e, f) {
                            ...
                            if (A != null && g())
                                if (x = (w = a.Pe.fields.first(({
                                    ...
                                    if (H.ok) return k4(() => {
                                        const K = M => {
                                            var Q;
                                            return (Q = H.value[0]) === null || Q === void 0 ? void 0 : Q.TBb.includes(M)
                                        };
                                        a.dm(() => ({
                                            O1: !1,
                        ...
                        return {
                            ...
                            cia: function(w) {
                                const u = r(),
                                    x = p === "poll" && w === (u === null || u === void 0 ? void 0 : u.gf) && w === (u === null || u === void 0 ? void 0 : u.LF);
                                if (g() && x) k(w);
                                    ...
                                    var y = u === null || u === void 0 ? void 0 : u.LF;
                                    k4(() => {
                                        const A = r();
                                        a.dm(() => ({
                                            vz: t({
                    ...
                    j4 = function({
                        ...
                        var f;
                        d = Math.max(0, ((f = e.fJ.get(c)) !== null && f !== void 0 ? f : 0) - 1);
                        f = new Map(e.fJ);
                        d > 0 ? f.set(c, d) : f.delete(c);
                        return {
                            fields: l4(a.fields, b, {
                                id: b,
                                fJ: f,
                    ...
                    i1b = function({
                        ...
                        var f;
                        d = ((f = e.fJ.get(c)) !== null && f !== void 0 ? f : 0) + 1;
                        return {
                            fields: l4(a.fields,
                                b, {
                                    id: b,
                        ...
                        for (let r = 0; r < h.length; r++) {
                            ...
                            m.push({ ...t,
                                ...
                                placement: a ? {
                                    ...
                                    gridRowStart: `${p+q}`,
                                    gridRowEnd: `${p+q+1}`,
                                    padding: t.padding ? m1b(t.padding) : void 0,
                    ...
                    n4 = function(a, b) {
                        ...
                        return __c.Ar(b, d => {
                            var e;
                            const f = (e = c.get(d)) !== null && e !== void 0 ? e : __c.ct(d, a);
                            c.set(d, f);
                            return f
                        })
                    },
                    p4 = function(a, b) {
                        return __c.bt(a, b) >= 20 ? a : n4(b, o4)
                    },
                    q4 = function(a) {
                        switch (a.type) {
                            case "color":
                                ...
                                cells: e.map(({
                                    ...
                                    return {
                                        ...
                                        content: {
                                            ...
                                            il: () => {
                                                var y;
                                                return b === null || b === void 0 ? void 0 : (y = b.cia) === null || y === void 0 ? void 0 : y.call(b, t.id)
                                            },
                                            onMouseEnter: () => {
                                                var y;
                        ...
                        switch (b) {
                            case 0:
                                ...
                                return {
                                    type: "text",
                                    uC: 1,
                                    text: u4((g = a.statusMessage) !== null && g !== void 0 ? g : a.messages.Xca(), c, d, n4(e, u1b), f)
                                };
                            case 1:
                                return {
                                    type: "text",
                                    uC: 1,
                                    text: u4(a.messages.loading(), c, d, n4(e, v1b), f)
                                };
                            case 2:
                                return {
                                    type: "text",
                                    uC: 1,
                                    text: u4(a.messages.Kza(), c, d, n4(e, v1b), f)
                                };
                            case 3:
                                return {
                                    type: "text",
                                    uC: 1,
                                    text: u4(a.messages.offline(), c, d, n4(e, w1b), f)
                                };
                            case 4:
                                return {
                                    type: "text",
                                    uC: 1,
                                    text: u4(a.messages.fza(), c, d, n4(e, x1b), f)
                                };
                            default:
                                throw new E(b);
                        }
                    ...
                    z1b = function({
                        ...
                        var h;
                        f = f.status === 1 ? ((h = f.data.Jza) === null || h === void 0 ? void 0 : h.type) === "ANON" ? b.XDa() : b.WDa() : b.Xca();
                        return [{
                            id: "footer",
                            size: "auto",
                            padding: [0, 20, 20, 20],
                            ...
                            content: m4({
                                ...
                                cells: c.map(({
                                    ...
                                    const r = d.status === 1,
                                        ...
                                        w = p.id === g;
                                    q = r && l && n.mode !==
                                        "edit" ? d.data.Yba(p.id) ? 5 : q ? 6 : 4 : n.mode === "edit" ? r && d.data.Yba(p.id) ? 5 : 4 : q ? 1 : w ? 3 : t ? 2 : 0;
                                    return {
                                        id: p.id,
                                        size: "auto",
                                        alignSelf: "center",
                                        content: {
                                            ...
                                            il: () => {
                                                var u;
                                                return a === null || a === void 0 ? void 0 : (u = a.cia) === null || u === void 0 ? void 0 : u.call(a, p.id)
                                            },
                                            onMouseEnter: () => {
                                                var u;
                    ...
                    F1b = function({
                        ...
                        const f = o4.includes(c),
                            {
                                h: g,
                                s: h,
                                ma: k
                            } = __c.Oka(c);
                        var l = new __c.Ns(g, h, k < 10 ? k + 6 : k - 6);
                        l = __c.$s(l);
                        var m = new __c.Ns(g, h, k < 10 ? k + 10 : k - 10);
                        m = __c.$s(m);
                        return {
                            id: "submit",
                            size: "auto",
                    ...
                    H1b = function({
                        ...
                        if (!m || !h ||
                            ...
                            var p;
                            k = f === l ? n4(f, o4) : f;
                            h = (h === null || h === void 0 ? void 0 : h.status) === 1 ? ((p = h.data.Jza) === null || p === void 0 ? void 0 : p.type) === "ANON" ? c.XDa() : c.WDa() : void 0;
                            return [F1b({
                                direction: b,
                                text: e,
                                v8a: k,
                ...
                __c.mD.prototype.qwa = __c.fa(12, function() {
                    return __c.hD(this, () => __c.UC(this.operators, "%", this.value))
                });
                var I1b = class {
                        constructor() {
                            this.type = "layout"
                ...
                var f4 = class {
                        ...
                        get AKa() {
                            ...
                            for (const b of this.list.value) {
                                const c = W3(this, b);
                                if (c === void 0) throw new b1b("undefined value found when deserializing list.");
                                a.push(c)
                            }
                            return a
                        }
                        ...
                        first(a) {
                            const b = this.list.value.first(a ? c => a(W3(this, c)) : void 0);
                            if (b != null) return W3(this, b)
                        }
                        last(a) {
                            const b = this.list.value.last(a ? c => a(W3(this, c)) : void 0);
                            if (b != null) return W3(this, b)
                        }
                        next(a, b) {
                            var c =
                                b ? d => b(W3(this, d)) : void 0;
                            a = X3(this, a);
                            c = this.list.value.next(a, c);
                            if (c != null) return W3(this, c)
                        }
                        Wb(a, b) {
                            var c = b ? d => b(W3(this, d)) : void 0;
                            a = X3(this, a);
                            c = this.list.value.Wb(a, c);
                            if (c != null) return W3(this, c)
                        }
                        map(a) {
                            return this.list.value.map((b, c) => a(W3(this, b), c))
                        }
                        filter(a) {
                            return this.list.value.filter((b, c) => a(W3(this, b), c)).map(b => W3(this, b))
                        }
                        forEach(a) {
                            return this.list.value.forEach((b, c) => a(W3(this, b), c))
                        }
                        some(a) {
                            return this.list.value.some(b => a(W3(this, b)))
                        }
                        constructor(a, b) {
                            this.uw = b;
                            this.S0a =
                                (f4.A(this), new WeakMap);
                            this.L0a = new WeakMap;
                            __c.C(a.type === "list");
                            this.list = a
                        }
                    },
                    e1b = class extends f4 {
                        replace(a, b) {
                            a = X3(this, a);
                            b = this.list.value.replace(a, this.uw.Ik(b));
                            return W3(this, b)
                        }
                        bN(a, b) {
                            a = a != null ? X3(this, a) : void 0;
                            b = this.list.value.bN(a, this.uw.Ik(b));
                            return W3(this, b)
                        }
                        cN(a, b) {
                            a = a != null ? X3(this, a) : void 0;
                            return this.list.value.cN(a, b.map(c => this.uw.Ik(c))).map(c => W3(this, c))
                        }
                        insertBefore(a, b) {
                            a = a != null ? X3(this, a) : void 0;
                            b = this.list.value.insertBefore(a, this.uw.Ik(b));
                            return W3(this, b)
                        }
                        append(a) {
                            a =
                                this.list.value.append(this.uw.Ik(a));
                            return W3(this, a)
                        }
                        prepend(a) {
                            a = this.list.value.prepend(this.uw.Ik(a));
                            return W3(this, a)
                        }
                        delete(a) {
                            a = X3(this, a);
                        ...
                        LD(a) {
                            this.list.value.LD(a ? b => a(W3(this, b)) : void 0)
                        }
                        Xr(a, b) {
                            a = a == null ? void 0 : X3(this, a);
                            b = X3(this, b);
                ...
                var M1b = e4({
                        type: ["t", b4(["text2"], "text2"), "readonly"],
                        text: ["te", function() {
                            const a = b => {
                    ...
                    P1b = g4($3("")),
                    Q1b = e4({
                        type: ["t", b4(["select"], "select"), "readonly"],
                        id: ["i", $3("")],
                        label: ["l",
                            y4
                        ],
                    ...
                    W1b = e4({
                        ...
                        G0: ["hh", function(a) {
                            const b = (c, d) => {
                                if (c == null) return a;
                                if ((c === null || c === void 0 ? void 0 : c.type) !== "boolean") throw d === "toWidgetData" ? new Y3("boolean", c) : new Z3("boolean", c);
                                return c.value
                            };
                            return {
                                Ik: c => ({
                ...
                var h1b = {
                    ...
                    Fe(a) {
                        return __c.Sr({
                            ...
                            action: a.action,
                            location: a.location,
                            linked_design_id: a.wIb,
                            toggle_value: a.TF,
                            editing_context: a.Wc == null ? void 0 : __c.Tr(a.Wc),
                            performance_context: a.kd == null ? void 0 : __c.Ur(a.kd)
                        })
                    }
                };
                var j1b = Symbol("UNABLE_TO_SUBMIT");
                var $1b = {
                        resultsPercentage: 0,
                    ...
                    a2b = class {
                        ...
                        ei(a) {
                            var b;
                            return (((b = this.xC) === null || b === void 0 ? void 0 : b.get(this.document.language || "en")) || [])[$1b[a]]
                        }
                        fza() {
                ...
                var c2b = class {
                    ...
                    get ow() {
                        if (!this.ru) return "#000000";
                        switch (this.ru.type) {
                            case "color":
                                return this.ru.color;
                            case "gradient":
                                return this.ru.eb.Vj[0].color;
                            default:
                                throw new E(this.ru);
                        }
                    }
                    get ts() {
                        if (!this.zu) return "#000000";
                        switch (this.zu.type) {
                            case "color":
                                return this.zu.color;
                            case "gradient":
                                return this.zu.eb.Vj[0].color;
                            default:
                                throw new E(this.zu);
                        }
                    }
                ...
                var r1b = 9 * __c.mU,
                    ...
                    w1b = ["#545454", "#c8c8c8"],
                    x1b = ["#e53935", "#ef5350"];
                var u4 = (a, b, c, d, e) => __c.ml.tc().attrs({
                    "font-size": v4,
                    leading: void 0,
                    "text-align": "center",
                    direction: t4(c),
                ...
                d2b = ({
                    ...
                    return a.status === 1 && b.status === 1 && a.data.rna !== b.data.rna || c
                };
                __c.WPa = {
                    S$a: function(a, b, c, d, e, f, g, h, k) {
                        g.tg("forms");
                        const {
                            rGb: l
                        } = d !== null && d !== void 0 ? d : {}, m = h.Iv("ui.rendering.form"), n = {
                            root: new I1b,
                            option: new I1b
                        }, p = new a2b(b);
                        return {
                                ...
                                if (l && a) {
                                    var r, t = K1b(() => q.Pe.id, () => {
                                            ...
                                            u === "poll" && (r = x.xIb({
                                                ...
                                                k4(() => {
                                                    const z = new Map(q.Kj.vz);
                                                    var B;
                                                    z.set(A, { ...((B = z.get(A)) !== null && B !== void 0 ? B : i4),
                                                        results: y
                                                    });
                                                    q.dm({
                                                        vz: z
                                            ...
                                            x.getSettings({
                                                ...
                                                let z = y;
                                                if (y.status === 1 && !q.Pe.eP && q.Pe.type === "quiz") {
                                                    var B, G;
                                                    const H = (G = (B = q.Pe.fields.first()) === null || B === void 0 ? void 0 : B.value.Mna.toArray()) !== null && G !== void 0 ? G : [];
                                                    z = {
                                                        status: 1,
                                                        data: {
                                                            Yba: I => H.includes(I),
                                                ...
                                                d2b({
                                                    ...
                                                    if (H.ok) {
                                                        ...
                                                        if (H.value) {
                                                            ...
                                                            ({
                                                                gf: M
                                                            } = (V = H.fAb.get(T)) !== null && V !== void 0 ? V : {});
                                                            var ba;
                                                            K.set(I, { ...((ba = K.get(I)) !== null && ba !== void 0 ? ba : i4),
                                                                gf: M,
                                                                LF: M
                                                            })
                                                        } else K.set(I, { ...((T = K.get(I)) !== null && T !== void 0 ? T : i4),
                                                            gf: void 0,
                                                            LF: void 0
                                                        });
                                                        q.dm({
                                        ...
                                        w = K1b(() => (k === null || k === void 0 ? void 0 : k.status) === 2, x4(u => {
                                            q.dm({
                                                Hj: u
                                            })
                                        }), {
