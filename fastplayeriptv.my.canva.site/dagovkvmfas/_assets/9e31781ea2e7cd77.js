    ...
    [60060], {
        ...
        82986: function(_, __, __webpack_require__) {
            ...
            (function(__c) {
                ...
                var E = __c.E;
                var Ha = __c.Ha;
                var v6b, w6b, y6b, x6b, A6b, D6b, C6b, H6b, K6b, L6b, O6b, Q6b, R6b, S6b, O5, P5, T6b, U6b, V6b, X6b, Z6b, $6b, e7b, f7b, T5, g7b, h7b, i7b, j7b, k7b, l7b;
                __c.I5 = function(a) {
                    return {
                        type: 1,
                        Component: a
                ...
                v6b = function({
                    ...
                    var b = u6b.get(a.gma);
                    if (!b) throw Error(`Blueprint ${a.gma} not found`);
                    b = b.variants.find(c => c.bQ === a.bQ);
                    if (!b) throw Error(`Variant ${a.bQ} not found for blueprint ${a.gma}`);
                    return {
                        Oa: b.Oa
                    }
                };
                ...
                y6b = async function(a, b) {
                    ...
                    if (e) {
                        ...
                        var f = setInterval(() => a.H2.BY.send({
                            type: "ack",
                            requestId: c
                        }), 9E3);
                        try {
                            ...
                            if (k instanceof M5) {
                                var h = k;
                                k.code === "internal_error" ? a.H.Eb(k, {
                        ...
                        if (h != null)
                            for (const k of a.$cb) try {
                                k(h)
                            } catch (l) {
                                a.H.nQ(l, {
                                    re: "Error executing errorObserver"
                                })
                            }
                    } else h = x6b(a.H2, c, "internal_error", `No request handler configured for path: "${d}".`),
                        h.ok || a.H.UL(h.error, {
                            re: "unable to send error response",
                            tags: new Map([
                                ["type", "request"],
                ...
                A6b = function({
                    ...
                    if (b.length !== 0 || !c.contains("allow-same-origin")) return z6b;
                    a = (new URL(a)).origin;
                    return a === "null" ? z6b : {
                        bDa: a,
                        BYa: a
                ...
                D6b = async function(a, b, c, {
                    ...
                    c = ({
                        ...
                        var n;
                        (k === null || k === void 0 ? 0 : (n = k.source) === null || n === void 0 ? 0 : n.startsWith("react-")) || (m !== g.bDa ? C6b(m) || b.info("received message event from an unexpected origin", {
                            extra: new Map([
                                ["expected", g.bDa],
                                ["actual", m]
                            ])
                            ...
                            source: "parent"
                        }, g.BYa, [a]), f.resolve(void 0)) : b.MK(l.error, {
                            extra: new Map([
                                ["data.source", k === null || k === void 0 ? void 0 : k.source]
                            ])
                        })))
                ...
                C6b = function(a) {
                    return E6b.some(b => a.endsWith(b))
                };
                H6b = function(a, b) {
                    var c = F6b,
                        d = G6b;
                    a.handle("SET_CONFIG", async e => {
                        if (e === void 0) throw new M5({
                            code: "internal_error",
                ...
                K6b = async function(a, b) {
                    a = await a.TIa.request("RENDER_ELEMENT", I6b.dc(b));
                    ...
                    return J6b.Lb(a.value)
                };
                L6b = function(a) {
                    H6b(a.TIa, b => a.handler.sgb(b))
                };
                O6b = async function(a, b, c) {
                    const {
                        port1: d,
                        port2: e
                    } = new MessageChannel, f = new M6b(d, c);
                    await D6b(e, c, a, window);
                    return new N6b(f, b)
                };
                Q6b = function({
                    H: a
                ...
                S6b = function(a) {
                    const b = a.color;
                    a = a.eb;
                    return b ? b : a.ref ? a.ref.Vj[0].color : "#ffffff"
                };
                O5 = function(a, b) {
                ...
                P5 = function(a, b) {
                    return {
                        type: "text2",
                        text: ml.create(ml.tc().attrs(b).Rb(a + "\n").build())
                    }
                };
                T6b = function(a, b) {
                    return {
                ...
                X6b = function(a) {
                    ...
                    return N5("div", {
                        className: "LMc7Uw",
                        children: a.options.map(d => N5(W6b, {
                            children: b(d)
                        }, c(d)))
                    })
                };
                Z6b = function(a) {
                    ...
                    const e = b !== c,
                        f = Y6b(() => {
                            var g = O5(c, Q5),
                                h = e ? b : g;
                            g = __c.bt("#000000", c) >= 20 ? "#000000" : O5(c, Q5);
                            h = __c.bt(h, c) >= 20 ? h : O5(c, Q5);
                            return d && e ? h : g
                        }, [e, d, b, c]);
                    return N5("div", {
                        className: "WYWuyA",
                        style: {
                            "--bETJ2A": d ? __c.Rs(__c.Ls(__c.Ms(f), e ? .5 : .08)) : __c.Rs(__c.Ls(__c.Ms(f), .08)),
                            "--yYV0bA": __c.Rs(__c.Ls(__c.Ms(f), .12)),
                            "--mxkqAA": __c.Rs(__c.Ls(__c.Ms(f), .26))
                        },
                        children: a
                    })
                };
                ...
                e7b = function(a) {
                    ...
                    switch (b) {
                        case 0:
                            return R5(a.Xca(), c, d, O5(e, a7b), f);
                        case 1:
                            return R5(a.loading(), c, d, O5(e, b7b), f);
                        case 2:
                            return R5(a.Kza(), c, d, O5(e, b7b), f);
                        case 3:
                            return R5(a.offline(), c, d, O5(e, c7b), f);
                        case 4:
                            return R5(a.fza(), c, d, O5(e, d7b), f);
                        default:
                            throw new E(b);
                    }
                };
                ...
                __c.sd.prototype.UL = __c.fa(3, function(a, b) {
                    this.console.error(...__c.rd(this, "critical", a, b))
                });
                __c.PL.prototype.UL = __c.fa(2, function(a, b) {
                    this.kt.UL(a, b);
                    __c.NL(this, a, "critical", b)
                });
                __c.S5 = {};
                T5 = __webpack_require__(519427);
                g7b = T5.action;
                h7b = T5.observable;
                i7b = T5.ObservableMap;
                j7b = T5.reaction;
                k7b = T5.runInAction;
                l7b = T5.untracked;
                var m7b = __webpack_require__(443763),
                    N5 = m7b.jsx,
                    U5 = m7b.jsxs;
                var V5 = __webpack_require__(875604),
                    ...
                    Y6b = V5.useMemo,
                    W5 = V5.useState;
                var p7b = __webpack_require__(635872).Om;
                var q7b = __webpack_require__(446474).Pi;
                var t6b = Object.freeze({
                ...
                var u6b = new i7b,
                    r7b = __c.L5({
                        element: {
                            gma: __c.K5("blueprintId", 0),
                            bQ: __c.K5("variantId", 0)
                        }
                    });
                var s7b = {
                    pH: __c.J5()(() => ({
                ...
                var M5 = class extends Error {
                    constructor(a) {
                        ...
                        this.aqb = a.message;
                        Object.setPrototypeOf(this, M5.prototype)
                    }
                };
                var u7b = class {
                    constructor(a, b, c) {
                        ...
                        this.onMessage = ({
                            ...
                            if (d) try {
                                ...
                                this.H.Eb(e)
                            } else this.H.error(new M5({
                                code: "internal_error",
                                message: "missing data in 'MessageEvent'"
                            }))
                        };
                        this.port.onmessage = this.onMessage;
                        this.port.onmessageerror = this.ynb
                    }
                };
                var v7b = class extends Error {
                        constructor() {
                        ...
                        const c = this.GVa,
                            ...
                            f = async function() {
                                ...
                                try {
                                    ...
                                    return g instanceof v7b ? Ha(new M5({
                                        code: "internal_error",
                ...
                var x7b = class {
                    handle(a, b) {
                        if (this.requestHandler.has(a)) throw new M5({
                            code: "internal_error",
                            ...
                            a = new y7b(c => {
                                switch (c.type) {
                                    ...
                                    case "response":
                                        ...
                                        break;
                                    case "request":
                                        y6b(this.requestHandler, c);
                                        break;
                                    default:
                                        throw new E(c);
                                }
                            }, a, b.tg("bus"));
                            this.client = new w7b(a.hz, b.tg("client"));
                            this.requestHandler = new x7b(a, b.tg("requestHandler"))
                        }
                    },
                    y7b = class {
                        constructor(a, b, c) {
                            this.kba = a;
                            this.hz = (d, e, f) => this.BY.send({
                                type: "request",
                                requestId: d,
                                path: e,
                                payload: f
                ...
                var E6b = "canva-dev.com canva-dev.cn canva-staging.com canva-staging.cn canva.com canva.cn canva-apps.com canva-apps.cn canva-apps-dev.com canva-apps-dev.cn canva-apps-staging.com canva-apps-staging.cn".split(" ");
                var I6b = L(() => ({
                    config: __c.Y(1)
                }));
                var z7b = L(() => ({
                ...
                var P6b = class {
                    async FB(a, b) {
                        const c = await O6b(a, {
                                sgb: e => {
                                    k7b(() => b.config = e.config);
                                    return new G6b
                                }
                            }, this.H),
                            d = j7b(() => b.config, async e => {
                                const f = await K6b(c, {
                                    config: e
                                });
                                f.config && f.config !== e && k7b(() => b.config = f.config)
                            }, {
                                fireImmediately: !0
                            });
                        this.jh.set(a, d)
                    ...
                    FU(a) {
                        var b;
                        (b = this.jh.get(a)) === null || b === void 0 || b();
                        this.jh.delete(a)
                    }
                    constructor(a) {
                        this.H = a;
                ...
                (a => ({
                    type: "select",
                    id: Jr(),
                    label: P5(O("RHbyaA"), T6b("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily)),
                    options: [O("ubIbsA"), O("Ic3T0Q"), O("gWITaA"), O("VqqAfQ")].map(b => ({
                        id: Jr(),
                        label: P5(b, U6b("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily))
                    })),
                    X: 8,
                    Mna: [],
                    fQa: "c",
                ...
                __c.PD.create({ ...__c.HQ,
                    weight: 0,
                    color: "#000000"
                });
                __c.NO.create({ ...__c.lv,
                    color: "#05805f"
                });
                __c.NO.create({ ...__c.lv,
                    color: "#05805f"
                ...
                var E7b, F7b = Jr(),
                    ...
                    H7b = [(a => {
                        ...
                        return {
                            type: "select",
                            id: Jr(),
                            label: P5(O("4JB6gw"), T6b("#0079a9", a === null || a === void 0 ? void 0 : a.fontFamily)),
                            options: b.map(c => ({
                                id: c.id,
                                label: P5(c.label, U6b("#0079a9", a === null || a === void 0 ? void 0 : a.fontFamily))
                            })),
                            X: 8,
                            Mna: b.filter(c => c.v1).map(c => c.id),
                            fQa: "c",
                            ...a
                        }
                    })({
                ...
                E7b = {
                    ...
                    header: {},
                    G0: !1,
                    border: __c.PD.create({ ...__c.HQ,
                        weight: 0,
                        color: "#000000"
                    }),
                    X: 16,
                    ru: __c.NO.create({ ...__c.lv,
                        color: "#0079a9"
                    }),
                    zu: __c.NO.create({ ...__c.lv,
                        color: "#0079a9"
                    }),
                    Am: __c.yh.Hc["font-family"],
                    direction: "l",
                    ...(void 0)
                };
                var J7b = __c.L5({
                ...
                var K7b = {
                    ...
                    L7b = class {
                        ...
                        ei(a) {
                            var b;
                            return (((b = this.xC) === null || b === void 0 ? void 0 : b.get(this.document.language || "en")) || [])[K7b[a]]
                        }
                        fza() {
                            return this.ei("somethingWentWrong") || O("Z3F9sQ")
                        }
                        Xca() {
                            return this.ei("live") || O("2LB66w")
                        }
                        xJa() {
                            return this.ei("correctLabel") || O("uXYgEw")
                        }
                        EOa() {
                        ...
                        DXa() {
                            return this.ei("responseSaved") || O("JWFDXg")
                        }
                        tTa(a) {
                        ...
                        offline() {
                            return this.ei("offline") || O("H7ta1A")
                        }
                        loading() {
                            return this.ei("loading") || O("/0w0UQ")
                        }
                        Kza() {
                            return this.ei("submitting") || O("+ecJQQ")
                        }
                        XDa() {
                            return this.ei("yourNameWontBeShared") || O("lC0Mpw")
                        }
                        WDa() {
                ...
                __c.LRa = {
                    Rhb: function(a) {
                        ...
                        const c = a.HDa,
                            d = a.W6;
                        return {
                            PAb: b("w:wnJF5T87v", s7b),
                            DCb: a.lcb ? Promise.all([__webpack_require__.me(697956).then(() => __c.P7b), __webpack_require__.me(411625).then(() => __c.Q7b), __webpack_require__.me(305660).then(() => __c.R7b), __webpack_require__.me(696820).then(() => __c.S7b)]).then(([e, f, g, h]) => ({
                                zCb: b("w:cm9wgGptP", e),
                                ACb: b("w:yLMS4dWnl", f),
                                BCb: b("w:2flp30CGQ", g),
                                CCb: b("w:1Nv6K6Dtv", h)
                            ...
                            form: b("w:6JG6DxspF", O7b),
                            LOb: a.gcb ? __webpack_require__.me(852979).then(() => __c.T7b).then(e => b("w:2pbXJMtm1", e)) : void 0
                        }
                    }
                };
...
//# sourceMappingURL=sourcemaps/9e31781ea2e7cd77.js.map